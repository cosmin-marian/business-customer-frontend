      ...
      "authorised users" must {
        ...
        "return Business Verification view for a user" in {
          ...
          businessVerificationWithAuthorisedUser { result =>
            ...
            document.select(".block-label").text() must include("I do not have a UK Unique Tax Reference")
    ...
    "when selecting Sole Trader option" must {
      ...
      "add additional form fields to the screen for entry for ATED" in {
        businessLookupWithAuthorisedUser("SOP", "ATED") { result =>
          ...
          document.getElementById("utr-help-questionAnswer").text() must include("It is issued by HMRC when you register your business or for Self-Assessment. If your UTR is 13 digits only enter the last 10.")
