...
class update_overseas_company_registrationSpec extends FeatureSpec with OneServerPerSuite with MockitoSugar with BeforeAndAfterEach with GivenWhenThen{
  ...
  feature("The user can view the overseas company registration question") {
    ...
    scenario("return overseas company registration view for a client") {
      ...
      val html = views.html.nonUkReg.update_overseas_company_registration(overseasCompanyForm, service, false, false, List(("UK", "UK")), None)
    ...
    scenario("return overseas company registration view for an agent") {
      ...
      val html = views.html.nonUkReg.update_overseas_company_registration(overseasCompanyForm, service, true, false, List(("UK", "UK")), None)
    ...
    scenario("return overseas company registration view for an agent adding a client") {
      ...
      val html = views.html.nonUkReg.update_overseas_company_registration(overseasCompanyForm, service, true, true, List(("UK", "UK")), None)
